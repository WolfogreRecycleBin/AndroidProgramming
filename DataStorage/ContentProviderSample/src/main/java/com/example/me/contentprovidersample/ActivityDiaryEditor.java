 ...
 */
public class ActivityDiaryEditor extends AppCompatActivity {
    private static final String TAG = "Diary";
    public static final String EDIT_DIARY_ACTION = "cn.edu.shu.cs.android.experiment05.data_contentprovider.EDIT_DIARY";
    public static final String INSERT_DIARY_ACTION = "cn.edu.shu.cs.android.experiment05.data_contentprovider.INSERT_DIARY";

    /**
     * 查询cursor时候，感兴趣的那些条例。
     */
    private static final String[] PROJECTION = new String[] { Diary.DiaryColumns._ID, // 0
            Diary.DiaryColumns.TITLE, Diary.DiaryColumns.BODY, // 1
    };
