...
public class DiaryContentProvider extends ContentProvider {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String sql = "CREATE TABLE " + DIARY_TABLE_NAME + " ("
                    + Diary.DiaryColumns._ID + " INTEGER PRIMARY KEY,"
                    + Diary.DiaryColumns.TITLE + " TEXT," + Diary.DiaryColumns.BODY
                    + " TEXT," + Diary.DiaryColumns.CREATED + " TEXT" + ");";
            //
            sql ="CREATE TABLE " + DIARY_TABLE_NAME + " ("
                    + Diary.DiaryColumns._ID + " INTEGER PRIMARY KEY,"
                    + Diary.DiaryColumns.TITLE + " varchar(255)," + Diary.DiaryColumns.BODY
                    + " TEXT," + Diary.DiaryColumns.CREATED + " TEXT" + ");";
            //
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case DIARY_ID:
                qb.setTables(DIARY_TABLE_NAME);
                qb.appendWhere(Diary.DiaryColumns._ID + "="
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        long rowId = db.insert(DIARY_TABLE_NAME, Diary.DiaryColumns.BODY, values);
        if (rowId > 0) {
    ...
    public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        return db
                .delete(DIARY_TABLE_NAME, Diary.DiaryColumns._ID + "=" + rowId, null);
    ...
    public int update(Uri uri, ContentValues values, String where,
        ...
        SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        String rowId = uri.getPathSegments().get(1);
        return db.update(DIARY_TABLE_NAME, values, Diary.DiaryColumns._ID + "="
                + rowId, null);
